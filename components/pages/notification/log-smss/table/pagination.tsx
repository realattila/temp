...
interface LogsSmsTablePaginationNotificationProps {
  pagination: {
    pageNumber: number;
    totalPages: number;
    pageSize: number;
...
const LogsSmsTablePaginationNotification: React.FC<LogsSmsTablePaginationNotificationProps> = ({
  pagination,
  handleChangePage,
}) => {
    ...
    <Form onSubmit={handleSubmitForm}>
      <div className='d-flex align-items-center justify-content-center mb-4 gap-4'>
        ...
        <strong className='me-4'>
          {t('table.pagination.content', { current: pagination.pageNumber, total: pagination.totalPages })}
        </strong>
      </div>
    </Form>
  );
...
export default LogsSmsTablePaginationNotification;
